...
template_path = os.path.normpath(os.path.join(
    ...
    os.pardir, os.pardir, os.pardir, 'tendril',
...
class EDASymbolGeneratorBase(SchemaControlledYamlFile):
    ...
    def _get_data_rc(self):
        ...
        # Specifically defined and qualified part names
...
def load(manager):
    manager.load_schema('EDASymbolGeneratorBase', EDASymbolGeneratorBase,
                        doc="Base Schema for Tendril "
                            "EDA Symbol Generator Files")
